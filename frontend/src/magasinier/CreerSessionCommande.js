...
import Swal from "sweetalert2";
import "./CreerSessionCommande.css";
...
const CreerSessionCommande = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:9090/api/session-commande/create",
        payload,
        {
  ...
  return (
    <div className="creer-session-page">
    <div className="session-card">
      <h2 className="session-title">🗓️ Créer une session de commande</h2>
